...
- **Build** — the 3D editor with two panels beside it, **Add** and **Edit**.
  - **Add** — one searchable catalog with category chips: Tools, Lumber & sheets, Brick / block & clay, Metal / rope & holds, Outdoor kitchen, Beds & play, Lighting & shade, Quick parts (ready-made 1 ft-grid assemblies) and Yours (custom parts). Tap a card to drop it in; tap a tool to set its sizes right there and **Place** it.
