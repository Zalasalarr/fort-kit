...
- **Tools** — in Build, **Build with a tool** lays real pieces for you: **Brick wall** (running bond with ⅜" joints, half-brick starts, end bricks cut to fit), **Deck** (rim and joists at 16" on center, 2×6 boards with ¼" gaps, 4×4 posts when raised), **Stud wall** (plates and studs at 16" or 24" OC, optional plywood sheathing), and **Ladder**. Set the sizes, tap Place, then drag it into position. Any assembly has an **Explode into pieces** button that rebuilds it from real lumber, sheets, bricks, rope, tube or holds.
