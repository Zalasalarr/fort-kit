...
- **Build** — the 3D editor. Drag a part to move it (snaps to the 1 ft grid), drag empty space to orbit, scroll or pinch to zoom. Turn, copy, delete, change height and material. Add parts from the strip at the bottom. **Marks** toggles on-model callouts.
