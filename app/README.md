...
- **Outdoor kitchen** — drop-in gas grill, gas grill cart, pellet smoker, kamado, wood-fired and portable pizza ovens, undercounter fridge, bar sink with a gooseneck faucet, concrete countertop (cut to length), cabinet doors and drawer fronts (they stick to a face), bar stool, fire pit ring with logs and flame.
